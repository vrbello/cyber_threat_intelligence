...
9 | File | `/admin/ajax.php?action=save_order` | High
10 | File | `/admin/ajax_products_list.php` | High
11 | File | `/admin/approve.php` | High
12 | File | `/Admin/changepassword.php` | High
13 | File | `/admin/delete_student.php` | High
14 | File | `/admin/manage_academic.php` | High
15 | File | `/admin/new-autoortaxi-entry-form.php` | High
...
21 | File | `/api/admin/update_account/` | High
22 | File | `/api/baskets/{name}` | High
23 | File | `/api/blade-user/submit` | High
24 | File | `/api/v1` | Low
25 | File | `/api /v3/auth` | High
26 | File | `/application/admin/logic/FilemanagerLogic.php` | High
27 | File | `/application/index/controller/Databasesource.php` | High
28 | File | `/backup.pl` | Medium
29 | File | `/bidlog.php` | Medium
30 | File | `/blog` | Low
31 | File | `/booknow.php?roomname=Duplex` | High
32 | File | `/C6/JHSoft.Web.AcceptAip/AcceptShow.aspx/` | High
33 | File | `/cas/logout` | Medium
34 | File | `/cfgFile/fileContent` | High
35 | File | `/cgi-bin/account_mgr.cgi?cmd=cgi_user_add` | High
36 | File | `/cgi-bin/cstecgi.cgi` | High
37 | File | `/cgi-bin/download_config.cgi` | High
38 | File | `/cgi-bin/wlogin.cgi` | High
39 | File | `/conf/app.conf` | High
40 | File | `/config/config.json` | High
41 | File | `/contact.php` | Medium
42 | File | `/controllers/Blocks.php` | High
43 | File | `/CPE` | Low
44 | File | `/details.php` | Medium
45 | File | `/download` | Medium
46 | File | `/downloadas/` | Medium
47 | File | `/Employer/EditProfile.php` | High
...
51 | File | `/gena.cgi` | Medium
52 | File | `/goform/apPortalPhoneAuth` | High
53 | File | `/goform/ArpNerworkSet` | High
54 | ... | ... | ...
