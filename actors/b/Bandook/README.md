...
2 | File | `/add-book.php` | High
3 | File | `/adfs/ls` | Medium
4 | File | `/admin-api/mp/material/upload-temporary` | High
5 | File | `/admin/attendance_action.php` | High
6 | File | `/admin/changeimage.php` | High
7 | File | `/admin/edit-teacher-detail.php` | High
8 | File | `/admin/eligibility.php` | High
9 | File | `/admin/payment_save.php` | High
10 | File | `/admin/profile.php` | High
11 | File | `/admin/settings/index.php?page=accounts` | High
12 | File | `/admin/sysmon.php` | High
13 | File | `/AGE0000700/GetImageMedico?fooId=1` | High
14 | File | `/api/content/posts/comments` | High
15 | File | `/api/login/auth` | High
16 | File | `/api/v1/terminal/sessions/?limit=1` | High
17 | File | `/asms/classes/Master.php?f=delete_transaction` | High
18 | File | `/bin/httpd` | Medium
19 | File | `/bin/posix/src/ports/POSIX/OpENer` | High
...
28 | File | `/dev/nvme0n1` | Medium
29 | File | `/domain/add` | Medium
30 | File | `/editBranchResult.php` | High
31 | File | `/editmyexp.php` | High
32 | File | `/etc/pki/pesign` | High
33 | File | `/get_work_dir_files` | High
...
38 | File | `/Home/GetAttachment` | High
39 | File | `/include/menu_v.inc.php` | High
40 | File | `/index.php` | Medium
41 | File | `/index.php?action=profile;u=2;area=showalerts;do=remove` | High
42 | File | `/librarian/lab.php` | High
43 | File | `/login.aspx` | Medium
44 | ... | ... | ...
