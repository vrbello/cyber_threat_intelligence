...
6 | T1068 | CWE-250, CWE-264, CWE-266, CWE-267, CWE-269, CWE-272, CWE-284 | Execution with Unnecessary Privileges | High
7 | ... | ... | ... | ...
...
15 | File | `/admin/between-dates-application-report.php` | High
16 | File | `/admin/confirm.php` | High
...
28 | File | `/admin/execedituser.php` | High
...
40 | File | `/admin/subscriber-csv.php` | High
41 | File | `/admin/SysModule/upload/ajaxmodel/upload/uploadfilepath/sysmodule_1` | High
42 | File | `/admin/vacancy/controller.php` | High
43 | File | `/AGE0000700/GetImageMedico?fooId=1` | High
44 | File | `/ajax.php?action=delete_customer` | High
45 | File | `/ajax.php?action=delete_product` | High
46 | File | `/api/admin/store/product/list` | High
47 | File | `/api/admin/store/product/save` | High
48 | File | `/api/admin/system/store/order/list` | High
49 | File | `/api/blade-system/menu/list?updatexml` | High
50 | File | `/api/controllers/merchant/shop/PosterController.php` | High
51 | File | `/api/environments/` | High
52 | File | `/api/files/recipepictures/` | High
53 | File | `/api/upload` | Medium
54 | File | `/api/v1/serve/awel/flow/import` | High
55 | File | `/api/v1/settings` | High
56 | File | `/api/v2/categories` | High
57 | File | `/api/v2/users-management/users` | High
58 | File | `/api/wizard/getBasicInfo` | High
59 | File | `/api/wizard/getCapability` | High
60 | File | `/app/admin/controller/Images.php` | High
61 | File | `/app/admin/instructions/edit-result.php` | High
62 | File | `/app/fax/fax_view.php` | High
63 | File | `/App/Tpl/Admin/Default/Channel/index.html.Attackers` | High
64 | File | `/app/xml_cdr/xml_cdr_details.php` | High
65 | File | `/application/pay/controller/Api.php` | High
66 | File | `/apply.cgi` | Medium
67 | File | `/art-enquiry.php` | High
68 | File | `/auth_files/photo/` | High
69 | File | `/billaction.php` | High
70 | File | `/bin/httpd` | Medium
71 | File | `/binutils/debug.c` | High
72 | ... | ... | ...
