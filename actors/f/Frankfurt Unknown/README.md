...
2 | File | `/admin/SysModule/upload/ajaxmodel/upload/uploadfilepath/sysmodule_1` | High
3 | File | `/admin/system.html` | High
4 | File | `/backend/admin/his_admin_add_lab_equipment.php` | High
5 | File | `/C6/JHSoft.Web.AcceptAip/AcceptShow.aspx/` | High
6 | File | `/cgi-bin/cstecgi.cgi` | High
7 | File | `/cgi-bin/p1_ftpserver.php` | High
8 | File | `/classes/Users.php?f=save_client` | High
9 | File | `/endpoint/add-folder.php` | High
10 | ... | ... | ...
