...
-- | ---------- | -------- | -------- | ----------
1 | [45.83.28.169](https://vuldb.com/ip/45.83.28.169) | - | - | High
2 | [85.239.246.89](https://vuldb.com/ip/85.239.246.89) | vmi2647172.contaboserver.net | - | High
3 | [91.219.239.49](https://vuldb.com/ip/91.219.239.49) | emojohbokloc-dedicated.serverastra.com | - | High
4 | ... | ... | ... | ...
...
2 | File | `/admin/layout` | High
3 | File | `/admin/profile/save_profile` | High
4 | File | `/admin/success_story.php` | High
5 | File | `/api/v4/teams/TEAM_ID/top/team_members` | High
6 | File | `/bin/ate` | Medium
7 | File | `/collection/all` | High
8 | File | `/computer/(agent-name)/api` | High
9 | File | `/cupseasylive/statemodify.php` | High
10 | File | `/dashboard/add-service.php` | High
11 | File | `/endpoint/add-leads.php` | High
12 | File | `/etc/shadow.sample` | High
13 | File | `/frontend/x3/cpanelpro/filelist-thumbs.html` | High
...
* https://urlhaus.abuse.ch/url/3682752/
* https://urlhaus.abuse.ch/url/3700850/
* https://urlhaus.abuse.ch/url/3719001/
* https://urlhaus.abuse.ch/url/3729948/
