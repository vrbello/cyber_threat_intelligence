...
3 | T1562.006 | CWE-184 | Missing Protection for Mirrored Regions in On-Chip Fabric Firewall | High
...
-- | ---- | --------- | ----------
1 | File | `/goform/form2Wl5BasicSetup.cgi` | High
2 | File | `cmd.exe` | Low
3 | File | `src/client.Rs` | High
4 | ... | ... | ...
