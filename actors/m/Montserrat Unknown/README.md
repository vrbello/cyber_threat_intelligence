...
4 | File | `/admin/Add%20notice/add%20notice.php` | High
...
22 | File | `/ari/asterisk/variable` | High
23 | File | `/assetsGroupReport/fixedAssetsList.j%73p` | High
24 | File | `/backend/register.php` | High
25 | File | `/blog` | Low
26 | File | `/boaform/getASPdata/formFirewall` | High
27 | File | `/boafrm/formParentControl` | High
28 | File | `/category/order/hits/copyright/46/finish/1/list/1` | High
29 | File | `/CDGServer3/logManagement/backupLogDetail.jsp` | High
30 | File | `/cgi-bin/cstecgi.cgi` | High
31 | File | `/cgi-bin/cstecgi.cgi?action=exportOvpn&type=user` | High
...
36 | File | `/client/manage/ourphp_out.php` | High
37 | File | `/config/config.json` | High
38 | File | `/control/register_case.php` | High
39 | File | `/control/WANIPConnection` | High
40 | File | `/debug/pprof` | Medium
41 | File | `/delete.php` | Medium
42 | File | `/display/map` | Medium
43 | File | `/Doc/deleteDoc.do` | High
44 | File | `/dottie.js` | Medium
45 | File | `/dtale/chart-data/1` | High
46 | File | `/Employer/EditProfile.php` | High
47 | File | `/forgot-password.php` | High
48 | File | `/fort/portal_login` | High
49 | File | `/forum/away.php` | High
50 | File | `/goform/apPortalPhoneAuth` | High
51 | File | `/goform/setcfm` | High
52 | File | `/HNAP1` | Low
53 | File | `/includes/get_message_ajax.php` | High
54 | File | `/index.php?menu=asterisk_cli` | High
55 | ... | ... | ...
