...
3 | File | `/addfriend.php` | High
4 | File | `/add_member.php` | High
5 | File | `/add_student/` | High
...
13 | File | `/admin/add_activity.php` | High
14 | File | `/admin/add_distributor.php` | High
15 | File | `/admin/add_expenses.php` | High
16 | File | `/admin/admin_edit_menu.php` | High
...
21 | File | `/admin/config_Anticrack.php` | High
22 | File | `/admin/doctor-specilization.php` | High
23 | File | `/admin/edit-course.php` | High
24 | File | `/admin/edit-nurse.php` | High
25 | File | `/admin/edit-subadmin.php` | High
26 | File | `/admin/edit_expenses.php` | High
27 | File | `/admin/index.php` | High
28 | File | `/admin/index.php?r=banner%2Fbanner-create` | High
29 | File | `/admin/manage-pages.php` | High
30 | File | `/admin/modules/class/index.php?view=view` | High
31 | File | `/admin/mod_amenities/index.php?view=add` | High
32 | File | `/admin/new-requests.php` | High
33 | File | `/admin/Operations/Role.php` | High
34 | File | `/admin/receipt.php` | High
35 | File | `/admin/redirect.php` | High
36 | File | `/admin/registration.php` | High
37 | File | `/admin/search-report-details.php` | High
38 | File | `/admin/search1.php` | High
39 | File | `/admin/search_staff_for_deletion.php` | High
40 | File | `/admin/services/manage_service.php` | High
41 | File | `/admin/setup.cgi` | High
42 | File | `/admin/subject/controller.php` | High
43 | File | `/admin/time-table.php` | High
44 | File | `/admin_info.php` | High
45 | File | `/admin_pic.php` | High
46 | File | `/admin_single_student.php` | High
47 | File | `/ajax.php?action=delete_borrower` | High
48 | File | `/ajax.php?action=save_plan` | High
49 | File | `/apartment-visitor/edit-apartment.php` | High
50 | ... | ... | ...
