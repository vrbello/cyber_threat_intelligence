...
2 | T1600.001 | CWE-321 | Key Management Error | High
...
-- | ---- | --------- | ----------
1 | File | `/com/esafenet/servlet/ajax/UsbKeyAjax.java` | High
2 | File | `/fpassword.php` | High
3 | File | `owntracks/views.py` | High
4 | ... | ... | ...
