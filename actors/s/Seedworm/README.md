...
These _indicators_ were reported, collected, and generated during the [VulDB CTI analysis](https://vuldb.com/kb/cti) of the actor known as [Seedworm](https://vuldb.com/actor/seedworm). The _activity monitoring_ correlates data from social media, forums, chat rooms, and darknet markets. It helps to determine associated actors, specific activities, expected intentions, emerging research, and ongoing attacks. Our unique _predictive model_ uses _big data_ to forecast activities and their characteristics.

_Live data_ and more _analysis capabilities_ are available at [https://vuldb.com/actor/seedworm](https://vuldb.com/actor/seedworm)
...
-- | ---------- | -------- | -------- | ----------
1 | [34.117.59.81](https://vuldb.com/ip/34.117.59.81) | 81.59.117.34.bc.googleusercontent.com | - | Medium
2 | [37.187.78.41](https://vuldb.com/ip/37.187.78.41) | ns3366607.ip-37-187-78.eu | - | High
3 | [104.21.48.205](https://vuldb.com/ip/104.21.48.205) | - | - | High
4 | ... | ... | ... | ...
...
_Tactics, techniques, and procedures_ (TTP) summarize the suspected MITRE ATT&CK techniques used by _Seedworm_. This data is unique as it uses our predictive model for actor profiling.
...
These _indicators of attack_ (IOA) list the potential fragments used for technical activities like reconnaissance, exploitation, privilege escalation, and exfiltration by Seedworm. This data is unique as it uses our predictive model for actor profiling.
