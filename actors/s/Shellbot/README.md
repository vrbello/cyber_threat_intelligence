...
6 | File | `/admin/mod_room/index.php?view=edit` | High
7 | File | `/admin/network/wifi_schedule` | High
8 | File | `/admin/quote-details.php` | High
9 | File | `/admin/save.php` | High
10 | File | `/admin/team_save.php` | High
11 | File | `/admin/user/user-move-run.php` | High
12 | File | `/admin_class.php` | High
13 | File | `/ajax.php?action=login` | High
14 | File | `/animalsadd.php` | High
15 | File | `/boafrm/formDosCfg` | High
16 | File | `/cgi-bin/cstecgi.cgi` | High
17 | File | `/cgi-bin/mainfunction.cgi/apmcfgupload` | High
18 | File | `/cgi-bin/web_index.cgi?lang=en&src=AwSystem.html&ertqVvnKV4TjU9Vt` | High
19 | File | `/chetc/shutdown` | High
20 | File | `/classes/Master.php?f=delete_product` | High
21 | File | `/classes/Users.php?f=save_user` | High
22 | File | `/cms/classes/Users.php?f=delete_client` | High
23 | File | `/control/activate.php` | High
24 | File | `/dashboard/admin/submit_payments.php` | High
25 | File | `/edit_profile` | High
