...
19 | File | `/admin/vca/bia/addacph.cgi` | High
...
24 | File | `/advancesearch.php` | High
...
30 | File | `/api/auditPublishing/get` | High
31 | File | `/api/authentication/login` | High
32 | File | `/api/config/raw` | High
...
53 | File | `/boafrm/formPinManageSetup` | High
...
70 | File | `/carManager/carUseDetailList.j%73p` | High
