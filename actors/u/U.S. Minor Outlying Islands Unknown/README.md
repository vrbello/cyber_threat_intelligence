...
31 | File | `/enrollment_edit1.php` | High
32 | File | `/etc/passwd` | Medium
33 | File | `/expense-datewise-reports-detailed.php` | High
34 | File | `/file-manager/upload.php` | High
35 | File | `/forum/away.php` | High
36 | File | `/function/audit/newstatistics/mon_stat_top10.php` | High
37 | File | `/goform/formSetWanStatic` | High
38 | File | `/goform/RP_checkCredentialsByBBS` | High
39 | File | `/goform/WifiBasicSet` | High
40 | File | `/home/editrefugee.php` | High
