...
12 | File | `/admin/admin_edit_employee.php` | High
...
17 | File | `/admin/assets/plugins/DataTables/media/unit_testing/templates/dom_data.php` | High
...
24 | File | `/admin/delete_s1.php` | High
25 | File | `/admin/delete_s8.php` | High
...
36 | File | `/admin/update-clients.php` | High
37 | File | `/admin/user/list` | High
38 | File | `/admin/view_products.php` | High
39 | File | `/adminapi/product/product_export` | High
40 | File | `/administrator/addcategory.php` | High
41 | File | `/adminPage/conf/saveCmd` | High
42 | File | `/ajax.php` | Medium
43 | File | `/ajax.php?action=delete_sales` | High
...
47 | File | `/api/wizard/getNetworkConf` | High
48 | File | `/api/wizard/getssidname` | High
49 | File | `/api/wizard/networkSetup` | High
50 | File | `/api2/html/` | Medium
51 | File | `/app-api/v1/members/openid/` | High
52 | File | `/app/Http/Controllers/ImageController.php` | High
...
57 | File | `/Attachment/fromImageUrl` | High
58 | File | `/b2b-supermarket/shopping-cart` | High
59 | File | `/bin/boa` | Medium
60 | File | `/boaform/admin/formLogin` | High
61 | File | `/boafrm/formIpQoS` | High
62 | File | `/boafrm/formLtefotaUpgradeFibocom` | High
63 | File | `/boafrm/formPingDiagnosticRun` | High
64 | File | `/boafrm/formTracerouteDiagnosticRun` | High
65 | File | `/borrow_book.php` | High
...
70 | File | `/check.php` | Medium
71 | File | `/classes/Master.php?f=delete_category` | High
72 | File | `/classes/SystemSettings.php?f=update_settings` | High
73 | ... | ... | ...
