...
24 | File | `/admin/activity.php` | High
25 | File | `/admin/add-module.php` | High
26 | File | `/admin/add-subadmins.php` | High
...
61 | File | `/admin/edit_activity_query.php` | High
62 | File | `/admin/edit_admin_query.php` | High
63 | File | `/admin/expenses.php` | High
64 | File | `/admin/freelist_main.php` | High
65 | File | `/admin/index.php` | High
66 | File | `/admin/index.php/advtext/add` | High
67 | File | `/admin/index.php/datafile/delfile` | High
68 | File | `/admin/index.php/datafile/download` | High
...
90 | File | `/admin/system/variableList.do` | High
91 | File | `/admin/system/variableSave.do` | High
92 | File | `/admin/templets_one_edit.php` | High
93 | File | `/admin/update-progress.php` | High
94 | File | `/admin/update_student.php` | High
95 | File | `/admin/update_user.php` | High
96 | File | `/admin/user-bookings.php` | High
...
107 | File | `/admin/view_products.php` | High
108 | ... | ... | ...

There are 958 more IOA items available (file, library, argument, input value, pattern, network port). Please use our online service to access the data.
