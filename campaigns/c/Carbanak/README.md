...
4 | File | `/admin/transaction/deposit` | High
5 | File | `/book_search.php` | High
6 | File | `/cgi-bin/mainfunction.cgi/apmcfgupload` | High
7 | File | `/dashboard/admin/edit_member.php` | High
8 | ... | ... | ...
