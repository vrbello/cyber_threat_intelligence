...
11 | File | `/admin/action/update-deworm.php` | High
12 | File | `/admin/admin_login_process.php` | High
...
24 | File | `/admin/operations/travellers.php` | High
...
30 | File | `/admin/request-received-bydonar.php` | High
31 | File | `/admin/return_add.php` | High
32 | File | `/admin/role/list` | High
33 | File | `/admin/sys/admin.html` | High
...
38 | File | `/admin_route/inc_service_credits.php` | High
39 | File | `/api.php` | Medium
40 | File | `/api/controllers/admin/app/AppController.php` | High
41 | File | `/api/controllers/admin/app/ComboController.php` | High
42 | File | `/api/controllers/common/UploadsController.php` | High
...
50 | File | `/application/index/controller/Datament.php` | High
...
55 | File | `/application/index/controller/Service.php` | High
...
67 | File | `/boaform/device_reset.cgi` | High
...
73 | File | `/clientdetails/admin/index.php` | High
74 | File | `/core/config-revisions` | High
75 | File | `/crm/data/pdf.php` | High
76 | ... | ... | ...
