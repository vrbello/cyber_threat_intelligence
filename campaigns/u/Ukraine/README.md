...
3 | File | `/admin/modules/class/index.php?view=view` | High
4 | File | `/admin/patients/manage_history.php` | High
5 | File | `/ajax.php?action=delete_expired` | High
6 | File | `/apartment-visitor/report.php` | High
7 | File | `/apartment-visitor/visitor-entry.php` | High
8 | File | `/api/users_handler.php` | High
9 | File | `/appointmentapproval.php` | High
10 | File | `/archive4.php` | High
11 | File | `/attendance-php/Admin/createClass.php` | High
12 | File | `/base-boot/actuator` | High
13 | File | `/billing.php` | Medium
14 | File | `/cap.js` | Low
