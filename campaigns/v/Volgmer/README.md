...
38 | File | `/admin/readDeal.php?mudi=clearWebCache` | High
39 | File | `/admin/reportupload.aspx` | High
40 | File | `/admin/subscriber-csv.php` | High
41 | File | `/admin/vacancy/controller.php` | High
42 | File | `/AGE0000700/GetImageMedico?fooId=1` | High
43 | File | `/ajax.php?action=delete_customer` | High
44 | File | `/ajax.php?action=delete_product` | High
45 | File | `/api/admin/store/product/list` | High
46 | File | `/api/admin/store/product/save` | High
