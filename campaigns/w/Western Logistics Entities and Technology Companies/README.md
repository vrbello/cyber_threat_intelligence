...
9 | File | `/admin/activity.php` | High
...
18 | File | `/admin/fetch_product_details.php` | High
...
29 | File | `/admin/system/structure/getdirectorydata/web/baseinfo/companyManage` | High
30 | File | `/admin/view-member-report.php` | High
31 | File | `/Administrator/PHP/AdminAddUser.php` | High
32 | File | `/api/jobs` | Medium
33 | File | `/api/member/avatar` | High
34 | File | `/api/v1/settings` | High
35 | File | `/api/v1/vdeskintegration/user/isenableuser` | High
36 | File | `/app/checkout/delete.php` | High
37 | File | `/app/register.php?action=reg` | High
38 | File | `/BBfile/Blood/o+.php` | High
...
45 | File | `/cgi-bin/firewall.cgi` | High
46 | File | `/cgi-bin/imode_alldata.php` | High
47 | File | `/cgi-bin/login.cgi` | High
48 | File | `/cgi-bin/p1_ftpserver.php` | High
49 | File | `/cgi-bin/settings-firewall.cgi` | High
50 | File | `/cgi-bin/skk_set.cgi` | High
51 | File | `/cgi-bin/UploadCfg` | High
...
55 | File | `/CMSInstall/install.aspx` | High
56 | File | `/com/esafenet/servlet/ajax/MultiServerAjax.java` | High
57 | File | `/com/esafenet/servlet/ajax/PublicDocInfoAjax.java` | High
